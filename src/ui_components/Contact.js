...
class Contact extends React.Component {
    ...
    sendMessage = (e) =>{
        ...
        const {name, emailid, phonenum, usertype,maildesc} = this.state;
        firestore.collection('Mails').doc('userEmails').collection(emailid).doc(timeStamp).set({
            Name: name,
            sendTime:new Date(),
            Email: emailid,
            Phone: phonenum,
            ...
            console.log("Mail data added to collection.");
                                    ...
                                    <form>
                                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div className="form-group">
                                                ...
                                                <input name="name" onChange={this.handleChange} id="name" type="text" placeholder="Name" className="form-control" required/>
                                            </div>
                                        </div>
                                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div className="form-group">
                                                <label className="control-label sr-only " for="email"></label>
                                                <input name="emailid" onChange={this.handleChange} id="email" type="text" placeholder="Email" className="form-control" required/>
                                            </div>
                                        </div>
                                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div className="form-group">
                                                <label className="control-label sr-only " for="Phone"></label>
                                                <input name="phonenum" onChange={this.handleChange} id="phone" type="text" placeholder="Phone" className="form-control" required/>
                                            </div>
                                        </div>
                                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div className="form-group">
                                                <label className="control-label required sr-only" for="select"></label>
                                                <select name="usertype" onChange={this.handleChange} className="form-control">
                                        ...
                                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 mb20">
                                            <div className="form-group">
                                                ...
                                                <textarea name="maildesc" onChange={this.handleChange} className="form-control pdt20" id="textarea"  rows="4" placeholder="Message"></textarea>
                                            </div>
                                        </div>
                                        <div className="col-lg-12 col-md-12 col-sm-6 col-xs-12">
                                            <button onClick={this.sendMessage} className="btn btn-primary btn-lg ">Send message</button>
                                        </div>
                                    </form>
                                </div>
                            </div>

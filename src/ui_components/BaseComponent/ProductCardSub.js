                ...
                <div className="card-layout">
                    ...
                    <div className="card-bottom">
                        <div className="card-icons">
                            ...
                            <CopyToClipboard text={`https://kidstation-version1.firebaseapp.com/${product.collection.stringValue}/${product.productid.stringValue}`} onCopy={copiedFunc}>
                                <Link>
                                    <span className="card-share-icon"><FileCopyOutlinedIcon style={{fontsize:'2rem'}}  /></span>
                                </Link>
                            </CopyToClipboard>
                        </div>

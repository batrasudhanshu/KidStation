...
import { TextField, InputAdornment,ListItem,List,ListItemText, IconButton, FormControl } from '@material-ui/core';
...
class SearchFilter extends Component {
    ...
    render() {
      ...
      return (
        <>
            <div className="nav-searchfilter-lg">
            <div className="global-search-lg">
              <div className="global-search-input-lg">
                <Paper
                  elevation={5}
                  component="form"
                >

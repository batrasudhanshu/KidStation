    ...
    render() {
        ...
        return (
            <div>
                ...
                <Dialog className="filter-sort-dialog" maxWidth={'lg'} disableBackdropClick disableEscapeKeyDown open={open} onClose={this.handleClose}>
                    <DialogTitle className="filter-sort-dialog-title">Fill the Fields</DialogTitle>
                    <DialogContent>

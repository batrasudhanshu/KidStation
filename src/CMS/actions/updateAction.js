...
// export const updatePen = (PenData) => {
//     return (dispatch, getState,{getFirebase, getFirestore} ) => {
//         const firestore = getFirestore();
//         const firebase = getFirebase();
//         const storage = firebase.storage();
//         const uploadtask = storage.ref('pens/'+PenData.image.name).put(eraserData.image);
//         uploadtask.on(
//             "state_changed",
//             snapshot => {
//                 const progress = Math.round(
...
//                     .then(url => {
//                         console.log(url, 'image uploaded');
//                         firestore.collection('pens').doc(eraserData.productid).update({
//                             ...eraserData,
//                             image: null,
//                             image_url: url
//                         }).then(()=>{

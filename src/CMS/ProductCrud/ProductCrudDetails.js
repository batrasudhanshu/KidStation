...
class ProductCrudDetails extends React.Component {
    ...
    render() {
        const {productname, productprice, productdescription, bestselling, disabled} = this.state;
        let {currentProduct} = this.props;
                    ...
                    {currentProduct && <Grid container spacing={3}>
                        ...
                        <Grid item xs={12} md={6}>
                            ...
                            <div className="crud-details-dropzone">
                                ...
                                <Button className="cms-crudfield-submit-btn" onClick={this.uploadImage} size="large" variant="contained" color="primary">Upload</Button>
                                </div>
                            </div>
                        </Grid>
                        <Grid item xs={12} md={6}>
                            <form className="crud-details-form" noValidate autoComplete="off">
                                <TextField className="crud-details-field" id="standard-basic" value={productname} name="productname" onChange={this.handleChange} label="Product Name" variant="outlined" disabled={disabled}/>
                                <TextField className="crud-details-field" id="filled-basic" value={productprice} name="productprice"  onChange={this.handleChange} label="Product Price" variant="outlined" disabled={disabled} />
                                <TextField className="crud-details-field" id="outlined-basic" value={productdescription} name="productdescription"  onChange={this.handleChange} label="Product Description" multiline variant="outlined" disabled={disabled} />
                                ...
                                <Button className="cms-crudfield-submit-btn" onClick={this.updateProduct} size="large" variant="contained" color="primary">Update</Button>
                            </form>
                        </Grid>
                    </Grid>}
            </>

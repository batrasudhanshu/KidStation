            ...
            <div className="enter-value-page">
                <Grid container spacing={3}>
                   <Grid item xs={12} md={12} sm={12} lg={12}>
                    ...
                    <div>
                        <img src="https://cdn.dribbble.com/users/285475/screenshots/2083086/dribbble_1.gif" width="100%" height="400vh"/>
                    </div>
                    </Grid>
                    <Grid item xs={12} md={7} sm={12} lg={7}>
                        <div className="enter-value-right">
                        <span><h2 style={{color:'#DF013A',fontSize:'5rem'}}>Look like you're lost<SentimentDissatisfiedIcon style={{color:'#04B404',fontSize:'3rem'}}  /></h2></span>

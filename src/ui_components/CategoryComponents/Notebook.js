...
const Notebook = () => {
    ...
    <div className="header">
        ...
        xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 500 500" space="preserve">
        ...
        <i className="fa fa-book notebook_icon" aria-hidden="true"></i>
        <h1>Notebooks & Registers</h1>
        </div>
